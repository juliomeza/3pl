...
export default function LoginPage() {
  const { signInWithGoogle, signInWithMicrosoft, user, userInfo, loading } = useAuth();
    ...
    <div className="flex items-center justify-center min-h-screen bg-background">
      <Card className="w-full max-w-md mx-4">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-headline text-2xl">Log in to Reliable 3PL</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          ...
          <Button variant="outline" className="w-full" onClick={signInWithMicrosoft}>
