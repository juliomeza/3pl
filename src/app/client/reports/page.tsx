...
export default function ClientReportsPage() {
  ...
  const [expandedCategory, setExpandedCategory] = useState<string | null>('inventory'); // Default to inventory expanded
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'available':
        return <Badge variant="default" className="bg-green-100 text-green-700 text-xs">Available</Badge>;
      case 'pending':
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="flex items-center gap-3 min-w-[300px] justify-between h-auto p-4">
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-lg ${selectedReport.categoryColor} text-white`}>
                      <selectedReport.categoryIcon className="w-4 h-4" />
                    </div>
