...
export function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden py-24 md:py-40 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-5 gap-8 items-center">
          <div className="relative z-10 lg:col-span-3">
            <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-gray-400 mb-6 mr-0 sm:mr-10 md:mr-20 lg:mr-32 leading-tight">
