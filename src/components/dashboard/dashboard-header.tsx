...
export function DashboardHeader({ leftContent, rightContent, centerContent, showWelcomeMessage = false }: DashboardHeaderProps) {
  ...
  return (
    <div className="flex items-center w-full">
      {centerContent ? (
        // Layout for centered content (like step indicators)
        <>
          {/* Left side - welcome message or left content */}
          ...
          {/* Right side - avatar and right content */}
        ...
        // Default layout with justify-between
        <>
