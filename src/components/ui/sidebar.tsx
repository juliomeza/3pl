  ...
  (
    ...
    return (
       <div
        ref={ref}
        className={cn(
            "hidden md:flex flex-col h-screen duration-200 ease-in-out transition-all border-r",
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2 mt-auto border-t",
    ...
    const button = (
       <Comp
        ...
        className={cn(
            ...
            state === 'collapsed' && 'justify-center w-10',
            className
        )}
        {...props}
      >
